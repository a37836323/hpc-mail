const zh = {
    ...
    createAccount: '创建账户',
    orContinueWith: '或者使用',
    completeRegistration: '完成账户创建',
    close: '关闭',
    oauthUsernameDescription: '为第三方登录设置一个独立用户名。',
    completeRegistrationAction: '完成注册',
    oauthSigningIn: '正在完成登录…',
    ...
    oauthFailed: '第三方登录未完成，请重试',
    oauthStateInvalid: '第三方登录校验已失效，请重新发起登录',
    ...
    catchAllEnabled: '已设为 Catch-all 收件箱',
    enableCatchAll: '设为 Catch-all 收件箱',
    mailboxActions: '邮箱操作',
    loading: '加载中…',
    loadMore: '加载更多',
