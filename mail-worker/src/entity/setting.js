...
export const setting = sqliteTable('setting', {
	...
	feishuWebhookUrl: text('feishu_webhook_url').default('').notNull(),
	feishuBotSecret: text('feishu_bot_secret').default('').notNull(),
	...
	noRecipient: integer('no_recipient').default(0).notNull(),
