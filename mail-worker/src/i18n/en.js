const en = {
	...
	recipientLimit: 'A message supports at most 100 recipients',
	invalidMessageBody: 'Invalid email body',
	messageBodyLimit: 'Email body must not exceed 5 MiB',
	invalidDisplayName: 'Display name must contain 1-50 printable characters',
	invalidFeishuWebhook: 'Invalid Feishu webhook URL. Only official custom bot URLs are allowed',
	emptyFeishuWebhook: 'Configure the Feishu webhook URL first',
	feishuWebhookFailed: 'Feishu bot request failed',
