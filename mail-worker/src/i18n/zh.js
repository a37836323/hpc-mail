const zh = {
	...
	tooManyLoginAttempts: '登录尝试过于频繁，请稍后再试',
	invalidUsername: '用户名必须为 3 至 32 位，仅允许字母、数字、点、下划线和短横线',
	...
	attLimit: '附件不能超过10个',
	attSizeLimit: '单个附件不能超过 25MB',
	attTotalSizeLimit: '附件总大小不能超过 25MB',
	...
	invalidSender: '发件人信息不完整',
	invalidSenderLocalPart: '发件地址前缀不合法',
	invalidEmailHeader: '邮件头包含非法换行符',
	recipientLimit: '单封邮件最多支持 100 个收件人',
	invalidMessageBody: '邮件正文格式不正确',
	messageBodyLimit: '邮件正文不能超过 5 MiB',
	invalidDisplayName: '显示名称需为 1-50 个可打印字符',
	invalidFeishuWebhook: '飞书 Webhook 地址无效，仅支持飞书官方自定义机器人地址',
	emptyFeishuWebhook: '请先配置飞书机器人 Webhook 地址',
	feishuWebhookFailed: '飞书机器人请求失败',
